...
# resource "aws_ec2_tag" "alb_tag_private" {
...
# resource "aws_ec2_tag" "alb_tag_private_kubernetes" {
#   for_each    = toset(data.aws_subnets.private.ids)
#   resource_id = each.value
...
# resource "aws_ec2_tag" "alb_tag_public_kubernetes" {
#   for_each    = toset(data.aws_subnets.private.ids)
#   resource_id = each.value
#   key         = "kubernetes.io/cluster/${module.eks_cluster.eks_cluster_id}"
#   value       = "shared"
...
# module "oidc_provider_ssm_parameters" {
#   source = "../../modules/ssm-parameter"
#   ssm_parameters = [
#     {
#       name        = "/${var.namespace}/${var.environment}/oidc_provider"
...
#     },
#     {
#       name        = "/${var.namespace}/${var.environment}/oidc_provider_arn"
...
#   role       = "${var.namespace}-${var.environment}-eks-iac-workers"
